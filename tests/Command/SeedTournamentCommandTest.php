...
class SeedTournamentCommandTest extends FixturesWebTestCase
{
    ...
    public function testSeedsFiveRoundsWithDoublingWeights(): void
    {
        $tester = $this->tester();
        ...
        $this->assertSame(
            ...
            'Het rondegewicht moet per ronde verdubbelen.'
        );

        $matches = $this->em->getRepository(FootballMatch::class)->findAll();
        $this->assertCount(31, $matches, '16 + 8 + 4 + 2 + 1 = 31 wedstrijden.');
        ...
        // 16 wedstrijden in de eerste ronde (16e finales).
